...
export const projects = [
    ...
    },
    {
        ...
        link: 'https://github.com/Severino-Gouveia/threads',
    },
    {
        iconUrl: car,
        theme: 'btn-back-blue',
        name: 'Aplicativo para encontrar carros',
        description: 'Construí um aplicativo móvel para encontrar e comparar carros no mercado, agilizando o processo de compra de carros.',
        link: 'https://github.com/Severino-Gouveia/car_showcase',
    },
    {
        iconUrl: snapgram,
        theme: 'btn-back-pink',
        name: 'Clone do Instagram ',
        description: 'Construí um clone completo do Instagram, permitindo aos usuários compartilhar fotos e se conectar com amigos em um ambiente familiar de mídia social.',
        link: 'https://github.com/Severino-Gouveia/social',
    },
    {
        iconUrl: estate,
